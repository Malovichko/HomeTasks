...
class ConstraintActivity: AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        buttonEditToolbar = findViewById(R.id.edit)
        buttonEdit = findViewById(R.id.canvas_edit)
        buttonBack = findViewById(R.id.arrow_back)
        textViewName = findViewById(R.id.data_name)
        textViewSurname = findViewById(R.id.data_surname)
        textViewEmail = findViewById(R.id.data_email)
        textViewLogin = findViewById(R.id.data_login)
        textViewRegion = findViewById(R.id.data_region)
    }
